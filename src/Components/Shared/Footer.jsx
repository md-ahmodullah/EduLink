export default function Footer() {
  return (
    <section className="mt-5">
      <footer className="bg-black text-base-content px-10 pt-10 font-roboto bg-[url('https://i.ibb.co.com/xqYDTxF/back-to-school.jpg')] bg-cover bg-no-repeat bg-blend-overlay bg-opacity-75">
        <div className="w-10/12 mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
          <aside className="grid-flow-col items-center">
            ...
            <div className="w-1/3 md:w-1/6 grid grid-cols-3 gap-12 text-gray-300 py-8">
              <a>
                <svg
        ...
        <aside className="flex justify-center pt-12 pb-5">
